# موقع دليل المستخدم - رافد KPI

موقع ويب تفاعلي لعرض دليل مستخدم منصة رافد KPI، يدعم اللغة العربية (RTL)، ومتوافق مع الطباعة، ويدعم رسوم Mermaid البيانية.
...
جميع الحقوق محفوظة © 2025 رافد KPI
