# موقع دليل المستخدم - مرتكز KPI

موقع ويب تفاعلي لعرض دليل مستخدم منصة مرتكز KPI، يدعم اللغة العربية (RTL)، ومتوافق مع الطباعة، ويدعم رسوم Mermaid البيانية.
...
جميع الحقوق محفوظة © 2025 مرتكز KPI
