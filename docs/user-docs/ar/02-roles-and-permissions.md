...
تعتمد منصة **مرتكز KPI** على نظام **التحكم في الوصول المبني على الأدوار (RBAC)**. يُخصَّص لكل مستخدم دور واحد داخل مؤسسته، ويُحدِّد هذا الدور الصفحات التي يمكنه زيارتها، والبيانات التي يمكنه الاطلاع عليها، والإجراءات التي يمكنه تنفيذها.
