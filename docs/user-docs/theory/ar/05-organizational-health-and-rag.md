...
درجة الصحة هي **مقياس مرجّح مركّب** يجمع إشارات متعددة. في  المؤشرات KPI، تشمل درجة الصحة المؤسسية:
...
مخططات التقدم الفصلي (مثل الموجودة في صفحة النظرة العامة ل المؤشرات KPI) تكشف هذه الأنماط بوضوح.
